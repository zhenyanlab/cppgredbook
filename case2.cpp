...
TEST(case2, curlhttp)
{
    ...
    if (curl)
    {
        const char *url = "http://www.baidu.com/a.test";
...
TEST(case2,cxxcurl){
    ...
    auto lens = strlen(str);
    std:cout <<"strlen:"<< lens << std::endl;
    ostringstream contentOutput;
    //long * HttpCodeResponse=new long(0);
    std::string * HttpCodeResponse=new string("");
    Request request = RequestBuilder()
            .url("http://www.baidu.com/a.txt")
            .followLocation(true)
    ...
    cout << "------------ HttpCode ------------"<<*HttpCodeResponse << endl;
